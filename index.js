...
console.log('%c🌉 Bienvenue sur SkillBridge!', 'color: #6366f1; font-size: 20px; font-weight: bold;');
console.log('%cConnectez-vous avec des étudiants passionnés', 'color: #8b5cf6; font-size: 14px;');
